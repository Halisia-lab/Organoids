  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        'fadeinleft': 'fade-in-left 0.7s ease-in 0.25s 1',
        ...
        'fadeinright': 'fade-in-right 0.7s ease-in 0.25s 1',
        ...
        'zoomin': 'zoom-in 0.1s ease-in forwards',
        'zoominimage': 'zoom-in-image 0.1s ease-in forwards',
