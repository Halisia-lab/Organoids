  ...
  const chooseImage = (image) => {
    ...
    fetchSegmentationByImageId(image.id)
      .then(res => {
        ...
        setMainSegmentation(res);
        setBrightness(res.brightness);
        setContrast(res.contrast)
        setBrightnessDisplayer(res.brightness);
        setContrastDisplayer(res.contrast)
          ...
          <div className="row-span-5 flex flex-col bg-black bg-opacity-30 text-xl py-4 px-5 justify-evenly">
            ...
            <div>
              <div className="flex items-center">
                <svg class="w-10 h-10 mx-3 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
